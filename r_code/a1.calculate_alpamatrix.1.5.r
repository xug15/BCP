...
abundance=read.csv('d:/a-document/sequencing_center_desktop/yanglab/dynamic_project/r_code/b6.com6.181716131415.bacteria.abundance.csv',row.names = 1)
abundance=read.csv('d:/a-document/sequencing_center_desktop/yanglab/dynamic_project/r_code/b6.com9.111079812.bacteria.abundance.csv',row.names = 1)
#
abundance=read.csv('d:/a-document/sequencing_center_desktop/yanglab/dynamic_project/r_code/b7.hn.48speciese.csv',row.names = 1)
#
...
predv=predict_abundance2(alpa,relative_abundance,dim(alpa)[1])
predv

#rownames(relative_abundance)

rownames(alpa)=rownames(relative_abundance)
colnames(alpa)=rownames(relative_abundance)
