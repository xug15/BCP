...
pathway=read.table('d:/a-document/sequencing_center_desktop/yanglab/dynamic_project/science.abm7841_data_s1/pathannotation/CAZymes_metagenome_with_description.tsv',sep="\t",row.names = 1,header = T)
...
write.csv(xdata,'d:/a-document/sequencing_center_desktop/yanglab/dynamic_project/science.abm7841_data_s1/pathannotation/caz.train.fullname.csv',row.names = F)
...
write.csv(ydata,'d:/a-document/sequencing_center_desktop/yanglab/dynamic_project/science.abm7841_data_s1/pathannotation/caz.label.csv')
##
#Run LASSO
