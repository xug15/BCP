...
pathway=read.table('d:/a-document/sequencing_center_desktop/yanglab/dynamic_project/science.abm7841_data_s1/pathannotation/Pfam_metagenome_with_description.tsv',row.names = 1,sep="\t",header = T)
...
write.csv(xdata,'d:/a-document/sequencing_center_desktop/yanglab/dynamic_project/science.abm7841_data_s1/pathannotation/pfam.train.fullname.csv',row.names = F)
write.csv(xdata2,'d:/a-document/sequencing_center_desktop/yanglab/dynamic_project/science.abm7841_data_s1/pathannotation/pfam.train.csv',row.names = F)

write.csv(ydata,'d:/a-document/sequencing_center_desktop/yanglab/dynamic_project/science.abm7841_data_s1/pathannotation/pfam.label.csv')
##
...
colnames(xdata_sub2)=paste('F',seq(dim(xdata)[2]),sep='')
write.csv(xdata_sub,'d:/a-document/sequencing_center_desktop/yanglab/dynamic_project/science.abm7841_data_s1/pathannotation/pfam.sub.train.fullname.csv',row.names = F)
write.csv(xdata_sub2,'d:/a-document/sequencing_center_desktop/yanglab/dynamic_project/science.abm7841_data_s1/pathannotation/pfam.sub.train.csv',row.names = F)
##
#Run LASSO
