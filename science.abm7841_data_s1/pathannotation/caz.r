...
write.csv(xdata_sub,'d:/a-document/sequencing_center_desktop/yanglab/dynamic_project/science.abm7841_data_s1/pathannotation/caz.sub.train.fullname.csv',row.names = F)
