...
fig.savefig(output+'.XGBoost_Gain_2.png', bbox_inches='tight', pad_inches = 0, dpi=200)
plt.show()
...
plot_model(model, output+'.autoencoder.png', show_shapes=True)
...
plot_model(encoder, output+'.encoder.png', show_shapes=True)
